...
ENV ANDROID_COMPONENTS extra-android-support,extra-google-google_play_services,extra-google-m2repository,extra-android-m2repository,addon-google_apis-google-24
ENV ANDROID_IMAGES sys-img-armeabi-v7a-android-21,sys-img-armeabi-v7a-android-22,sys-img-armeabi-v7a-android-23,sys-img-armeabi-v7a-android-24
